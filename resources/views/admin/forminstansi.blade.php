        ...
        <div class="modal-body">
          ...
          <form id="forminstansi" class="form-horizontal">
            <div class="form-group m-form__group row">
              ...
              <label id="telp" class="form-control-label col-lg-3 mt-4">Telp</label>
              <div class="col-lg-9 mt-4">
                <input type="text" name="telp" id="telp" class="form-control m-input" placeholder="Masukkan No Telp">
              </div>
