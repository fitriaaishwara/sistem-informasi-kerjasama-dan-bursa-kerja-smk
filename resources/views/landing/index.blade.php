...
<div class="card card-image" style="background-image: url(landing/images/bg2.jpg);height:500px;">
  <div class="text-white text-center rgba-stylish-strong py-5 px-4 mt-6">
    <div class="py-5">

      <!-- Content -->
      <h2 class="card-title text-white h2">Sistem Informasi Bursa Kerja Khusus</h2>
      <h5 class="h5 text-white mb-4">SMK NU 1 ISLAMIYAH KRAMAT TEGAL</h5>
      @guest
          ...
          <div class="col-lg-12 col-md-12">
            <div class="single_jobs white-bg d-flex justify-content-between">
              <div class="jobs_left d-flex align-items-center">
                <div class="thumb">
                  <img src="image/InfoLowongan/{{$data->foto}}" alt="">
                </div>
                <div class="jobs_conetent">
                  <a href="/form-single-lowongan;{{$data->id}}"><h4>{{$data->judul}}</h4></a>
    ...
    <div class="container mt-4">
      ...
      <div class="container-fluid">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          @if($pesan->count() >= 1)
            <div class="carousel-item col-md-4 active" hidden>
              <div class="card">
          ...
          @forelse($pesan as $p)
            ...
            @empty
            <center><i class="far fa-sad-tear"></i><h4>Belum ada Testimoni</h4></center>
            @endforelse
          </div>
          <br>
        </div>
